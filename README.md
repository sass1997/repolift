...
[![Go Report Card](https://goreportcard.com/badge/github.com/repolift/repolift)](https://goreportcard.com/report/github.com/repolift/repolift)
...
```bash
git clone https://github.com/repolift/repolift.git
cd repolift
